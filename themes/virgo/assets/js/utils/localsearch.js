...
// Tự động tập trung vào ô tìm kiếm
// scInput.focus();
scClear && (scClear.style = 'opacity: 0;')

// Mỗi lần load trang đều phân tích lại để lấy map nội dung toàn site hơi tốn hiệu năng
// Chúng ta thiết lập ở đây tối đa 24 tiếng phân tích lại một lần
// Và cho phép ép buộc lấy lại map nội dung mới nhất - thông qua click vào icon bên trái
function getDocMap() {
	let today = Date.now()
